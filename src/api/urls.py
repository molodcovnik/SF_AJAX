...
from .views import UsersList, ChatList, ChatListUser, UserChatListView, LastMessagesView, ChatDetailDestroyView, ProfileListView, ChatUpdate
...
urlpatterns = [
    ...
    path('chat/<str:room_name>/update/', ChatUpdate.as_view()),
